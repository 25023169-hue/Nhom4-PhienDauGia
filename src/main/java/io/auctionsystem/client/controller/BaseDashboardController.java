...
public abstract class BaseDashboardController {
    ...
    protected static final String ACTIVE_MENU_STYLE = "-fx-background-color: #1abc9c; -fx-text-fill: white; -fx-cursor: hand; -fx-alignment: CENTER_LEFT;";
    protected static final String INACTIVE_MENU_STYLE = "-fx-background-color: transparent; -fx-text-fill: #bdc3c7; -fx-cursor: hand; -fx-alignment: CENTER_LEFT;";
