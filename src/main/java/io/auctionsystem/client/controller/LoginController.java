                        ...
                        try {
                          ...
                          if (authResp.getRole() == Role.ADMIN) {
                            SceneManager.getInstance()
                                .switchScene("/client/fxml/admin_dashboard.fxml");
                          } else if (authResp.getRole() == Role.SELLER) {
                            SceneManager.getInstance()
                                .switchScene("/client/fxml/user/seller/seller_dashboard.fxml");
                          } else {
                            SceneManager.getInstance()
                                .switchScene("/client/fxml/user/bidder/bidder_dashboard.fxml");
                          }
                          // =========================================================
